...
2) Calculate an adjustment between population esimates from the CSA model and the mark-recapture experiment
3) Compare the estimates of population size from the mark-recapture experiments to those obtained from the annual red king crab survey using a catch-survey analysis model(CSA)
...
An objective of this study was to compare the estimates of population size from the mark recapture experiments to those obtained from the annual red king crab survey using a catch-survey analysis model(CSA). One method to do so is to establish an adjustment factor between these two estimates.  
